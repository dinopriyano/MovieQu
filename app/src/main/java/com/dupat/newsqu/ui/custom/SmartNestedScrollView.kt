package com.dupat.newsqu.ui.custom
...
class SmartNestedScrollView (context: Context, attrs: AttributeSet?, defStyleAttr: Int) : NestedScrollView(context, attrs, defStyleAttr) {
